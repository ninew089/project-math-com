...
public class test {
    public static void main(String[] args) {
        ...
        Work work[] = new Work[11];
        //เพิ่มพนักงานทดลองงาน ชื่อ Nadech ได้รับค่าจ้างรายชั่วโมง 80 บาท ลงใน array ช่องที่ 0
        work[0] = new Work("Nadech",80);
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Nadech ทำงาน 30 ชั่วโมง
        System.out.println(work[0].getName()+" gets "+work[0].weeklyPay(30));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Nadech ทำงาน 40 ชั่วโมง
        System.out.println(work[0].getName()+" gets "+work[0].weeklyPay(40));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Nadech ทำงาน 50 ชั่วโมง
        System.out.println(work[0].getName()+" gets "+work[0].weeklyPay(50));
        ...
        work[4] = new HourWorkerSpecial("Dome",120,20,3);
        ...
        System.out.println(work[9].getName()+" gets "+work[9].weeklyPay(25000,0));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Mint ทำยอดขายได้ 30000 บาท และขายสินค้าใหม่ไม่ได้เลย
        System.out.println(work[9].getName()+" gets "+work[9].weeklyPay(30000,0));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Mint ทำยอดขายได้ 35000 บาท และขายสินค้าใหม่ไม่ได้เลย
        System.out.println(work[9].getName()+" gets "+work[9].weeklyPay(35000,0));
       ...
       work[10] = new SaleWorkerManager("Ann",120,30000); 
        ...
        System.out.println(work[10].getName()+" gets "+work[10].weeklyPay(25000,1));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Mint ทำยอดขายได้ 30000 บาท และขายสินค้าใหม่ได้ 1 ชิ้น
        System.out.println(work[10].getName()+" gets "+work[10].weeklyPay(30000,1));
        //แสดงผลรายได้ต่อสัปดาห์ เมื่อ Mint ทำยอดขายได้ 35000 บาท และขายสินค้าใหม่ได้ 1 ชิ้น
        System.out.println(work[10].getName()+" gets "+work[10].weeklyPay(35000,1));
    }
